...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, factoryAddress) {
    ...
    if (((_CACHE = CACHE$1) === null || _CACHE === void 0 ? void 0 : (_CACHE$tokens$0$addre = _CACHE[tokens[0].address]) === null || _CACHE$tokens$0$addre === void 0 ? void 0 : _CACHE$tokens$0$addre[tokens[1].address]) === undefined) {
      ...
      CACHE$1 = _extends({}, CACHE$1, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_CACHE2 = CACHE$1) === null || _CACHE2 === void 0 ? void 0 : _CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(factoryAddress ? factoryAddress : FACTORY_ADDRESS, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
  ...
  currentPairs, originalAmountIn, bestTrades, factoryAddress) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (_amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route([].concat(currentPairs, [pair]), originalAmountIn.token), originalAmountIn, exports.TradeType.EXACT_INPUT, factoryAddress), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades, factoryAddress) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (_amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route([pair].concat(currentPairs), tokenIn), originalAmountOut, exports.TradeType.EXACT_OUTPUT, factoryAddress), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
